...
public class C01_NestedIfElse {
    public static void main(String[] args) {
        ...
        if (sayi < 1000 || sayi > 9999) {   // istenmeyen durumu yaziyoruz
            ...
            System.out.println("lutfen 4 basamakli sayi giriniz"); // 4 basamakli ve sayi 5'e tam bolunuyor

        } else if (sayi % 5 == 0) {  // 4 basamakli, 5 ile bolunebilen ve son rakami 0 olan
            ...
            if (sayi % 10 == 0) {
                ...
                System.out.println("5'ebolunen tek sayi");
